<template>
  <article>
    <nuxt-link :to="{ name: 'contents-slug', params: { slug: post.fields.slug }}" class="title">
    <img class="thumbnail"
    ...
    <h4><nuxt-link :to="{ name: 'contents-slug', params: { slug: post.fields.slug }}" class="title">{{ post.fields.title }}</nuxt-link></h4>
